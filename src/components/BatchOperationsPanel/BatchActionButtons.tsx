        ...
        <>
          ...
          {hasSelection ? (
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '6px',
                border: 'none',
                backgroundColor: unprocessedCount > 0 ? 'var(--color-accent)' : 'var(--color-border-subtle)',
                color: unprocessedCount > 0 ? 'white' : 'var(--color-text-muted)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid var(--color-border)',
              backgroundColor: videoCount > 0 ? 'var(--color-surface)' : 'var(--color-border-subtle)',
              color: videoCount > 0 ? 'var(--color-text)' : 'var(--color-text-muted)',
