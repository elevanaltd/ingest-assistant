  ...
  describe('Queue Management', () => {
    ...
    it('should process queue in FIFO order', async () => {
      ...
      const mockProcessor = vi.fn(async (fileId: string) => {
        ...
        return { success: true, result: { mainName: fileId, metadata: [], confidence: 0.9 } };
      });
    ...
    it('should reject adding to queue when another batch is active', async () => {
      ...
      const mockProcessor = vi.fn(async () => {
        ...
        return { success: true, result: { mainName: 'test', metadata: [], confidence: 0.9 } };
      });
  ...
  describe('Queue Persistence', () => {
    ...
    it('should restore queue state from disk on initialization', async () => {
      const persistedState = {
        items: [
          { fileId: 'file1', status: 'completed', result: { mainName: 'test1', metadata: [], confidence: 0.9 } },
